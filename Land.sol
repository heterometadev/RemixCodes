...
//OpenZeppelin library for Adding features for ERC721
...
//totalSupply() : The function returns the total number of NFTs issued by the contract that are not burned.
...
contract Land is ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
    ...
    //Mapping for holding which address mint how much lands ?
    ...
    // Main mint function using markleProof verify from OpenZeppelin library
